...
describe('bitcoinjs basic', function(){

  it('use helloblock to run a full cycle', function(done){
...
//        tx.addOutput(dataScript, 2000)
    ...
    //        console.log(transaction);
            ...
            tx2.sign(0, key)
    // TODO trying to figure out bitcoin-lib's internals 
