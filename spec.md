...
The penny bank acts as a simple escrow where the funds are guaranteed to be available to the two parties, but only they can mutually agree to release any funds.  If either party stops cooperating or misbehaves, the funds at that point remain locked until cooperation begins again or the remaining proof of work is performed.
